...
public:
	...
	//CBaslerGigEInstantCameraArray *m_pCamera = nullptr;                 // Multi Camera
...
/*************************************************************************************************/
	...
	int OpenCamera(int nCamIndex, int nPosition);
	int CloseCamera(int nCamIndex);
    int ConnectCamera(int nCamIndex,int nOffsetX,int nOffsetY,int nWidth,int nHeight,CString strImgFormat);
	...
	void SetCameraReverseXPara(int nIndex, bool bSet);

	CString GetIpAdd(int nIndex);
