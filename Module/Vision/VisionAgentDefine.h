...
#define STATEBAR_NAME_RGB		RGB(160, 160, 160)			//상태바 이름 TEXT
#define STATEBAR_NAME_BK_RGB	RGB(45, 45, 45)					//상태바 이름 background
#define STATEBAR_VALUE_RGB		RGB(200, 200, 200)			//상태바 값 이름 TEXT
#define STATEBAR_VALUE_BK_RGB	RGB(90, 90, 90)					//상태바 값 background
#define STATEBAR_VALUE_GREEN  RGB(0, 128,0)					//Green
#define STATEBAR_VALUE_RED  RGB(200, 0,0)					//Red

#define BTN_LAMP_ON				RGB(255, 128, 0) //주황색
#define BTN_LAMP_OFF			RGB(128, 128, 128) //바탕색
