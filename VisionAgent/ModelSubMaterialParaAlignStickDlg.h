...
class CModelSubMaterialParaAlignStickDlg : public CDialogEx
{
	DECLARE_DYNAMIC(CModelSubMaterialParaAlignStickDlg)

public:
	CModelSubMaterialParaAlignStickDlg(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CModelSubMaterialParaAlignStickDlg();

// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_MODEL_SUB_MATERIAL_PARA_ALIGN_STICK_DIALOG  };
#endif
